...
import { z } from "zod";
import type { ITelemetry, TelemetryEvent as ITelemetryEvent } from "../contracts/telemetry.js";
...
const DEFAULT_CONFIG: TelemetryConfig = {
	endpoint: "https://localhost/telemetry",
...
export class TelemetryTracker implements ITelemetry {
	 ...
	 */
	track(event: ITelemetryEvent | TelemetryEvent): void {
